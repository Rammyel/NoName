...
function Demo2(props) {
    return (
        <>
            <Helmet>
                <title>No Name - Portfolio & Agency React Template </title>
            </Helmet>
            ...
            <BoxImageVertical src="/assets/img/project/project1/5.jpg" className="section-margin">
                ...
                <FadeUpTrigger tag={DsnGrid} col={1} rowGap={30} rowGapTablet={20}>
                    ...
                    <h6>
                        Иногда нам действительно нужно сфокусироваться на времени, чтобы закончить начатое,
                        и не отвлекаться на идеи других.
                    </h6>
                    <p>
            ...
            <Container className="section-margin dsn-right-container">
                <TitleSection description="Наша Команда">
                    Наверное, самая креативная команда в нашей компании!
                </TitleSection>
