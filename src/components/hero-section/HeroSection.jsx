...
const HeroContent = {
    title: "Привет! Мы здесь для того, чтобы сделать Вас узнаваемыми",
    description: `Мы бросаем вызов дизайну,
     чтобы продвинуть понимание о нём как об искусстве на новый уровень`,
    authorTitle: "Индивидуальный Подход",
    authorJob: "",
    experienceNumber: "ВАШ",
    experienceDescription: `Индивидуальный \nДизайн`,
